import {Player} from "./player.js?v=0.3.4";
import {World} from "./world.js?v=0.3.4";
import {Systems} from "./systems.js?v=0.3.4";
import {UI} from "./ui.js?v=0.3.4";
import {QuestSystem} from "./quests.js?v=0.3.4";
