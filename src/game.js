...
export class Game{
 ...
 load(){try{const raw=localStorage.getItem("starRepublicSave");if(!raw)return;const s=JSON.parse(raw);this.player.restore(s.player);this.world.restore(s.world)}catch(e){console.warn("save load",e)}}
