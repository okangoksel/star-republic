export class World{
 constructor(){this.width=1800;this.height=1100;this.time=6*60;this.day=1;this.screenOffsetX=0;this.screenOffsetY=0;this.farm={x:120,y:170,w:520,h:390};this.resources=[];this.weather="clear";this.weatherTimer=0;this.echoLevel=0;this.mineDepth=0;this.dawnWavePending=false;this.unlockedRegions={};this.settlement={level:0,upgrades:{}};this.hiddenDiscoveries={groveShrine:false,meteorCrater:false,oldCabin:false};this.bedInstalled=false;this.bedX=390;this.bedY=168;this.trees=[];this.makeWorld()}
 makeWorld(){
